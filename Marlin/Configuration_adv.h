...
#define XY_MOTOR_CURRENT 600       // 0.84 peak
#define EXTRUDER_MOTOR_CURRENT 700 // 1.0 peak
#define Z_MOTOR_CURRENT 700        // 1.0 peak

#if AXIS_IS_TMC(X)
#define X_CURRENT XY_MOTOR_CURRENT // (mA) RMS current. Multiply by 1.414 for peak current.
#define X_MICROSTEPS 16            // 0..256
#define X_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(X2)
#define X2_CURRENT 800
#define X2_MICROSTEPS 16
#define X2_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(Y)
#define Y_CURRENT XY_MOTOR_CURRENT
#define Y_MICROSTEPS 16
#define Y_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(Y2)
#define Y2_CURRENT 800
#define Y2_MICROSTEPS 16
#define Y2_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(Z)
#define Z_CURRENT Z_MOTOR_CURRENT
#define Z_MICROSTEPS 16
#define Z_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(Z2)
#define Z2_CURRENT 800
#define Z2_MICROSTEPS 16
#define Z2_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(Z3)
#define Z3_CURRENT 800
#define Z3_MICROSTEPS 16
#define Z3_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E0)
#define E0_CURRENT EXTRUDER_MOTOR_CURRENT
#define E0_MICROSTEPS 16
#define E0_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E1)
#define E1_CURRENT 800
#define E1_MICROSTEPS 16
#define E1_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E2)
#define E2_CURRENT 800
#define E2_MICROSTEPS 16
#define E2_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E3)
#define E3_CURRENT 800
#define E3_MICROSTEPS 16
#define E3_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E4)
#define E4_CURRENT 800
#define E4_MICROSTEPS 16
#define E4_RSENSE BOARD_RSENSE
#endif

#if AXIS_IS_TMC(E5)
#define E5_CURRENT 800
#define E5_MICROSTEPS 16
#define E5_RSENSE BOARD_RSENSE
#endif
...
#define CUSTOM_USER_MENU_TITLE "Macros"
#define USER_SCRIPT_DONE ""
#define USER_SCRIPT_AUDIBLE_FEEDBACK
#define USER_SCRIPT_RETURN // Return to status screen after a script

#define USER_DESC_1 "Full Power"
#define USER_GCODE_1 "M203 X450 Y450 Z24"

#define USER_DESC_2 "Silent Mode"
#define USER_GCODE_2 "M203 X60 Y60 Z6"

#define USER_DESC_3 "Probe Level"
#define USER_GCODE_3 "G28\nM851 Z0\nG90\nG1 Z0\nG91\nG1 X-10 F6\nG1 X+10 F6\nG1 X-10 F3\nG1 X+10 F3\nG1 X-10 F1\nG1 X+10 F1\nG1 X-10 F1\nG1 X+10 F1"

#define USER_DESC_4 "Z at 100"
#define USER_GCODE_4 "G1 Z100 F1440"

//#define USER_DESC_5 "X"
//#define USER_GCODE_5 "M117 Test"
#endif
